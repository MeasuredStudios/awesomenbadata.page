...
const NavBar = (props) => {
  ...
  return (
    <div tw="flex items-center justify-between px-5 h-16 flex items-center">
      ...
      <div tw="flex ml-auto">
        <div tw="relative">
          ...
          >
            ...
            <div tw="mr-2 w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center font-bold">
              JP
            </div>
          ...
          <div
            css={[
              tw`h-full w-full fixed top-0 right-0 z-10 opacity-20`,
          ...
          <div
            css={[
              tw`absolute right-0 mt-1 border rounded-sm py-2 shadow w-44 z-20`,
              avatarDropdown ? tw`block` : tw`hidden`,
            ]}
          >
            <ul tw="text-gray-500">
