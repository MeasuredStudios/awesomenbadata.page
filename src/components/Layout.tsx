...
const ExternalLink: React.FC = ({ href, children }) => {return (
    <a
...
const Layout: React.FC = ({ children, ...rest }) => {
  ...
  <div {...rest}>
    ...
    <div>
      <nav tw="sticky z-10 top-0 flex justify-between items-center max-w-4xl w-full p-8 my-0 md:my-8 mx-auto  bg-opacity-60">
        <ThemeToggle />
        <div>
          <a href="/dashboard" tw="p-1 sm:p-4">
            Dashboard
          </a>
          <a href="/blog" tw="p-1 sm:p-4">
            Blog
          </a>

          <a href="/about" tw="p-1 sm:p-4">
            About
          </a>

          <a href="/" tw="p-1 sm:p-4">
            Home
          </a>
        </div>
      </nav>
      <main tw="flex flex-col justify-center px-8">
        {children}
        <Footer />
      </main>
    </div>
